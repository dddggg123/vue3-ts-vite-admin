  ...
  <div class="login-container">
    ...
    <div class="login-section">
      ...
      <div class="footer-section">
        <span class="version">{{ $t("版本号") }}：1.0.22060101</span>
      </div>
    </div>
...
.login-container {
  ...
  width: 100%;
  overflow: hidden;
  background-image: linear-gradient(calc(160deg),
